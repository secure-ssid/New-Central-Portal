...
def _norm_device(d: dict) -> dict:
    ...
    return {
        ...
        # Also read the normalized spelling so re-normalizing an already
        # normalized dict keeps the id — event lookups use it to skip
        # centralmcp's per-call device-inventory round trip.
